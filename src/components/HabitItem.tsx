...
export const HabitItem: React.FC<HabitItemProps> = ({ task, date }) => {
  ...
  return (
    <div className={cn(
      "flex items-center justify-between p-4 rounded-lg border shadow-sm transition-all duration-300 ease-in-out",
      ...
      <Checkbox
        ...
        className={cn(
          "w-6 h-6 rounded transition-all duration-300 ease-in-out data-[state=checked]:bg-accent data-[state=checked]:border-accent border-2",
